  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <div style={{ marginTop: "2rem" }}>
        <Link to="/vendors">← Back to Vendors Years</Link>
      </div>
    </div>
  );
}

export default VendorPublicList;
